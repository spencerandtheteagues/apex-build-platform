...
func (ebs *EnterpriseBillingService) getFreePlanFeatures() []PlanFeature {
	return []PlanFeature{
		...
		{ID: "advanced_ai", Name: "Advanced AI Models", Description: "Access to max-tier models like GPT-5.4 and Gemini 3.1 Pro", Enabled: false},
...
func (ebs *EnterpriseBillingService) getProPlanFeatures() []PlanFeature {
	return []PlanFeature{
		...
		{ID: "advanced_ai", Name: "Advanced AI Models", Description: "Access to max-tier models like GPT-5.4 and Gemini 3.1 Pro", Enabled: true},
		{ID: "version_control", Name: "Git Integration", Description: "Git repository integration", Enabled: true},
