  ...
  <table width="100%%" cellpadding="0" cellspacing="0" style="background:#0f172a;min-height:100vh;">
    <tr><td align="center" style="padding:40px 20px;">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#1e293b;border-radius:12px;border:1px solid #334155;overflow:hidden;">
        <tr>
          <td style="padding:24px 40px;border-bottom:1px solid #334155;text-align:center;">
            <img src="https://apex-build.dev/apex-build-logo.png" alt="APEX-BUILD" width="160" style="display:block;margin:0 auto;" />
          </td>
        </tr>
        <tr>
