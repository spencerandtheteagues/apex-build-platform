...
DROP INDEX IF EXISTS idx_external_mcp_servers_project;
DROP INDEX IF EXISTS idx_external_mcp_servers_user;
DROP INDEX IF EXISTS idx_secret_audit_logs_secret;
DROP INDEX IF EXISTS idx_secrets_project;
DROP INDEX IF EXISTS idx_secrets_user_name;
DROP INDEX IF EXISTS idx_chat_messages_room_date;
DROP INDEX IF EXISTS idx_cursor_positions_room_active;
...
DROP INDEX IF EXISTS idx_executions_project_date;
DROP INDEX IF EXISTS idx_ai_requests_capability;
DROP INDEX IF EXISTS idx_ai_requests_provider_status;
DROP INDEX IF EXISTS idx_ai_requests_user_date;
DROP INDEX IF EXISTS idx_files_hash;
DROP INDEX IF EXISTS idx_files_project_path;
