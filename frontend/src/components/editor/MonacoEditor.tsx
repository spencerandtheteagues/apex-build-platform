...
const EDITOR_THEMES = {
  cyberpunk: {
    ...
    rules: [
      ...
      { token: 'keyword', foreground: 'ff4466' },
      ...
      { token: 'operator', foreground: 'ff4466' },
    ],
    colors: {
      'editor.background': '#0a0a0f',
      'editor.foreground': '#ffffff',
      'editor.lineHighlightBackground': '#220711',
      'editor.selectionBackground': '#ff003330',
      'editor.inactiveSelectionBackground': '#ff003315',
      ...
      'editorIndentGuide.activeBackground': '#ff003340',
    },
  },
  matrix: {
    base: 'vs-dark' as const,
...
const LANGUAGE_CONFIGS = {
  ...
  css: { id: 'css', defaultCode: 'body {\n    font-family: "Fira Code", monospace;\n    background: linear-gradient(135deg, #0a0a0f 0%, #220711 100%);\n    color: #ff4466;\n}' },
