...
describe('ProviderStatusBar', () => {
  ...
  it('treats ollama as a first-class configurable provider when BYOK is enabled', () => {
    ...
    render(
      <ProviderStatusBar
        providerPanels={[
          { provider: 'gpt4', status: 'completed', statusLabel: 'DONE', liveModelName: 'ChatGPT 5.4 Pro', available: true },
          ...
          { provider: 'claude', status: 'completed', statusLabel: 'DONE', liveModelName: 'Claude Opus 4.6', available: true },
