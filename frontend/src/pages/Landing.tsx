    ...
    <div className="launch-shell">
      ...
      <div className="pricing-grid">
        {([
          ...
          { name: 'Pro', price: '$59', features: ['Everything in Builder', 'Latest Ollama cloud models — high quality, lower cost', 'BYOK + budget caps', 'Max power mode & longer autonomous runs', '$40/mo in managed AI credits'], featured: true },
